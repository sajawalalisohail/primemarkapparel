...
Notes: ${formData.notes || "None"}`
  ...
  const inputClasses =
    "w-full px-4 py-3 bg-[var(--color-bg)] border border-[var(--color-border)] rounded-lg text-[var(--color-text-primary)] placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-[#C9A84C] focus:border-transparent hover:border-[#C9A84C]/50 transition-all duration-300 ease-in-out";
  ...
  if (isSuccess) {
    return (
      <Section id="rfq" className="bg-[var(--color-bg)]">
        <div className="max-w-2xl mx-auto text-center">
          <div className="p-8 rounded-xl bg-[var(--color-surface)] border border-[var(--color-border)] shadow-sm">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 text-sm text-green-600 hover:text-green-500 mb-6"
            >
    ...
    <Section id="rfq" className="bg-[var(--color-bg)]">
      <div className="max-w-2xl mx-auto">
        ...
        <form
          ...
          className="p-6 md:p-8 rounded-xl bg-[var(--color-surface)] border border-[var(--color-border)] shadow-sm"
        >
          ...
          <div className="mb-6">
            <label className="flex items-start gap-3 cursor-pointer">
              <input
                type="checkbox"
                required
                className="mt-1 w-4 h-4 text-[#C9A84C] border-[var(--color-border)] bg-[var(--color-bg)] rounded focus:ring-[#C9A84C] focus:ring-2"
              />
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a
              ...
              className="inline-flex items-center justify-center px-6 py-3 text-base font-medium bg-[var(--color-bg)] border border-[var(--color-border)] text-[var(--color-text-secondary)] rounded-lg hover:bg-[var(--color-surface)] transition-colors focus:outline-none focus:ring-2 focus:ring-[#C9A84C]"
            >
              <svg
