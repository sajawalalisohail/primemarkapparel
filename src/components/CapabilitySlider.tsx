...
const slides: Slide[] = [
  ...
  {
    headline: "MOQ: 200-300 Units",
    subtext: "Flexible minimum orders based on product type",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  {
    headline: "2-6 Week Lead Time",
    subtext: "Fast turnaround from sample approval to delivery",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    subtext: "Embroidery, printing, and private label options",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    subtext: "QC checks at every stage of production",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  {
    headline: "English-Speaking Team",
    subtext: "Clear communication throughout the process",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
