    ...
    <Section id="industries" className="bg-zinc-900">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {industries.map((industry, index) => (
          <div
            key={index}
            className="group flex flex-col items-center text-center p-6 rounded-xl bg-zinc-950 border border-zinc-800 hover:border-amber-500/50 transition-all duration-300"
          >
            <div className="mb-3 text-zinc-400 group-hover:text-amber-400 transition-colors">
              {industry.icon}
            </div>
