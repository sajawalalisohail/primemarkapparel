          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              <div className="p-4 rounded-lg bg-zinc-900 border border-zinc-800 text-center">
                <p className="text-2xl font-bold text-amber-400 mb-1">200+</p>
                <p className="text-sm text-zinc-400">Units MOQ</p>
              </div>
              <div className="p-4 rounded-lg bg-zinc-900 border border-zinc-800 text-center">
                <p className="text-2xl font-bold text-amber-400 mb-1">2-6</p>
                <p className="text-sm text-zinc-400">Weeks Lead Time</p>
              </div>
              <div className="p-4 rounded-lg bg-zinc-900 border border-zinc-800 text-center">
                <p className="text-2xl font-bold text-amber-400 mb-1">100%</p>
